...
@Component({
    selector: 'app-table123',
    templateUrl: './table123.component.html',
    styleUrls: ['./table123.component.css']
})
export class table123Component implements OnInit, OnChanges {
    ...
    ngOnChanges(changes){
        this.dataSource.data = this.ngModel33;
