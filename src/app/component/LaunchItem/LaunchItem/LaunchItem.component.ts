...
import { LaunchItemService } from './LaunchItem.service';
...
@Component({
    selector: 'app-LaunchItem',
    templateUrl: './LaunchItem.component.html',
    styleUrls: ['./LaunchItem.component.css'],
    providers: [ LaunchItemService ]
})
export class LaunchItemComponent implements OnInit {
    ...
    constructor(private service: LaunchItemService, private navigationService: NavigationService, private route: ActivatedRoute, private router: Router) {
    ...
    ngOnInit(): void {
        this.route.params.subscribe(params => {
            LaunchItemComponent.parameter_UID = params['UID'] == undefined ? LaunchItemComponent.parameter_UID : params['UID'];
            this.parameter_UID = LaunchItemComponent.parameter_UID;
